...
//        System.out.println(APIUtil.getResponseLISTBody().getTeachers().get(0).getFirstName());
        ...
        for (Teacher t : API_Utils.getResponseLISTBody().getTeachers()) {
...
//    }
        ...
        int index = 0;
        for (Student student : API_Utils.getResponseLISTBody().getStudents()) {
...
// will
    ...
    public void postTesting(){
       ...
       API_Utils.hitPOST("/teacher/create",teacher);
    ...
    public void deleteTesting(){
        ...
        API_Utils.hitDELETE("/teacher/delete/2741");
    }
...
//        String resource = "/teacher/update";
        ...
        API_Utils.hitPUT("/teacher/update", requestBody);
    }
